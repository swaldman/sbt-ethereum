...
val consuelaArtifact : ModuleID = "com.mchange" %% "consuela" % "0.2.0-SNAPSHOT" changing()
...
lazy val root = (project in file(".")).enablePlugins(ParadoxPlugin).settings (
  ...
  libraryDependencies ++= Seq(
    ...
    "com.mchange"    %% "mlog-scala"            % "0.3.13-SNAPSHOT" changing(),
    "com.mchange"    %% "literal"               % "0.1.0-SNAPSHOT" changing(),
    "com.mchange"    %% "danburkert-continuum"  % "0.3.99",
    "com.mchange"    %% "ens-scala"             % "0.2.1-SNAPSHOT" changing(),
