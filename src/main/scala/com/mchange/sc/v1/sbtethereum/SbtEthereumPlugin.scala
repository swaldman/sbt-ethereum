...
object SbtEthereumPlugin extends AutoPlugin {
  ...
  private def xethOnLoadShoeboxInitVerifyRecoverTask : Initialize[Task[Unit]] = Def.task {
    ...
    doShoeboxInitVerifyRecover( log, is, overrideShoeboxDirPath )
  }
  ...
  private def doShoeboxInitVerifyRecover( log : sbt.Logger, is : sbt.InteractionService, overrideShoeboxDirPath : Option[String] ) : Unit = {
